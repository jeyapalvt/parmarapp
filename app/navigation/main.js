...
import Combopack from '@screens/ComboPack';
...
import VisaService from '@screens/VisaService';
import AttractionBook from '@screens/AttractionBook';
import TicketViewer from '@screens/TicketViewer';
import LoginScreen from '@screens/LoginScreen';
import TourBook from '@screens/TourBook';
import BurjKhalifaBooking from '@screens/BurjKhalifaBooking';
import ComboBook from '@screens/ComboBook';
import OffersAndDiscounts from '@screens/OffersAndDiscounts';
import TopAttractions from '@screens/TopAttractions';
import TopDestinations from '@screens/TopDestinations';
import UpcomingTours from '@screens/UpcomingTours';
import WalletInfo from '@screens/WalletInfo';
import StripPay from '@screens/StripPay';
...
export default function Main() {
  return (
    <MainStack.Navigator
      ...
      {/* new screens Home Page */}
      <MainStack.Screen name="Attractions" component={Attractions} />
      <MainStack.Screen name="Combopack" component={Combopack} />
      ...
      <MainStack.Screen name="VisaService" component={VisaService} />
      <MainStack.Screen name="AttractionBook" component={AttractionBook} />
      <MainStack.Screen name="TicketViewer" component={TicketViewer} />
      <MainStack.Screen name="LoginScreen" component={LoginScreen} />
      <MainStack.Screen name="TourBook" component={TourBook} />
      <MainStack.Screen
        name="BurjKhalifaBooking"
        component={BurjKhalifaBooking}
      />
      <MainStack.Screen name="ComboBook" component={ComboBook} />
      <MainStack.Screen
        name="OffersAndDiscounts"
        component={OffersAndDiscounts}
      />
      <MainStack.Screen name="TopAttractions" component={TopAttractions} />
      <MainStack.Screen name="TopDestinations" component={TopDestinations} />
      <MainStack.Screen name="UpcomingTours" component={UpcomingTours} />
      <MainStack.Screen name="WalletInfo" component={WalletInfo} />
      <MainStack.Screen name="StripPay" component={StripPay} />
...
function BottomTabNavigator() {
  ...
  const theme = useSelector(state => state.application);
  ...
  return (
    <BottomTab.Navigator
      ...
      <BottomTab.Screen
        name="Profile"
        component={login ? Profile : LoginScreen}
        options={{
          title: t('account'),
          tabBarIcon: ({color}) => {
